                    ...
                    >
                        <div className="p-10">
                            <h2 className="text-2xl font-semibold">
                                Coding with ❤️ in Tucson, Arizona, where the local time is {new Date().toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })} and the weather is currently ____ and __°F.
                            </h2>
                        </div>
                    </motion.div>
                    <motion.div 
