...
tags:
    ...
    - test
category: Guide
updated: 2024-05-30T21:03:12.794Z
---
...
Of the many hooks that usehooks-ts provides, the one we'll be using today is named `useDebounceCallback` ([Documentation](https://usehooks-ts.com/react-hook/use-debounce-callback)).
...
#### Conditional Rendering witih TSX
...
- If the field **is not dirty** AND the user **is not typing**, render the `AppWindow` icon.
...
Here's the final code for the `SiteForm` component:
