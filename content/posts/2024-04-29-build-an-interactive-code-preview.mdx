...
![](/assets/posts/interactive-code-preview.png)
...
If you'd like to code along, create a Next.js project with the following command. If you're using Yarn, pnpm, or Bun as your package manager, see [here](https://nextjs.org/docs/pages/api-reference/create-next-app#interactive) for their equivalent commands.
...
![](/assets/posts/interactive-code-preview.gif)
