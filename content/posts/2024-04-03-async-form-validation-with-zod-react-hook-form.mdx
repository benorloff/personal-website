...
This post is a continuation of my series on building forms in Next.js. If you'd like to follow along, feel free to check out [Create Your First Next.js App](/blog/2024-03-27-create-your-first-nextjs-app) and [Create a Form with React Hook Form & Next.js](/blog/2024-04-01-create-a-form-with-react-hook-form-nextjs)
