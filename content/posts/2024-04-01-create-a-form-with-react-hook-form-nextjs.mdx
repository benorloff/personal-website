...
As ubiquitous as forms are in the context of web apps, their complexity can differ dramatically depending on the use case. For simple forms, you might be able to get away with using vanilla React state to manage form data. However, as your form grows in complexity, you'll likely find that you need a more robust solution.
...
<Callout type="info">
This guide assumes that you have already set up a Next.js project. If you need help setting up your Next.js project, check out ["Create Your First Next.js App"](/blog/2024-03-27-create-your-first-nextjs-app).
</Callout>
