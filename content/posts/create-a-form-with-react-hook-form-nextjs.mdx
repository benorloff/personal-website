...
<Callout type="info">This guide assumes that you have already set up a Next.js project. If you need help setting up your Next.js project, check out <a target="_blank" rel="noopener noreferrer nofollow" href="https://hashnode.com/post/clu9zsgon000408l55idlgd0j" >"Create Your First Next.js App"</a></Callout>
